...
\acmConference[BCB '26]{17th ACM International Conference on Bioinformatics,Computational Biology, and Health Informatics}{June 30--July 3,
 2026}{Rende, Italy}
%%
...
\title{Unsupervised Reference Modeling of Nanopore Signals for DNA/RNA Modification Detection}
...
\author{Yongji Zou}
\affiliation{%
  \institution{Center for Cellular and Molecular Therapeutics, Children's Hospital of Philadelphia}
  \city{Philadelphia}
  \state{PA}
  \country{USA}
}
\affiliation{%
  \institution{Bioengineering Graduate Program, University of Pennsylvania}
  \city{Philadelphia}
  \state{PA}
  \country{USA}
}

\author{Mian Umair Ahsan}
\affiliation{%
  \institution{Center for Cellular and Molecular Therapeutics, Children's Hospital of Philadelphia}
  \city{Philadelphia}
  \state{PA}
...
\keywords{Nanopore sequencing, DNA methylation, RNA modification, unsupervised learning, anomaly detection, variational autoencoder}
