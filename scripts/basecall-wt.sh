...
$DORADO/bin/dorado basecaller $DORADO/models/rna004_130bps_sup@v5.2.0 $in --recursive --modified-bases m5C_2OmeC m6A_DRACH pseU_2OmeU --emit-moves --device cuda:0  > $out/$genome.basecall.dorado.bam
